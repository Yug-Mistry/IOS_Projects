...
// Class responsible for managing table view data source and delegate for StudentModel data
class StudentDataSourceDelegate: NSObject {
    ...
    /// Initializes StudentDataSourceDelegate with data source, delegate, and table view
    /// - Parameters:
...
extension StudentDataSourceDelegate: UITableViewDelegate {
...
extension StudentDataSourceDelegate: UITableViewDataSource {
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        let cell = tblvw.dequeueReusableCell(withIdentifier: "StudentTVC", for: indexPath) as! StudentTVC
